/** ЗАДАЧА 57 - Параметры функции по умолчанию
 *
...
//1. Результатом логического выражения всегда будет булево значение. В данном случае mult = mult || 2 = true , что нарушает логику программы.
