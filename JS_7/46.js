/** ЗАДАЧА 46 - Сокращенное написание свойств объектов
 * 
...
const photosGallery = (title, dimensions, date) => {
  return {
    ...
    [dimensions] : true,
    publishInfo() {console.log(`Фото \"${title}\" было опубликовано ${Math.floor((new Date().getTime() - date.getTime()) / 1000)} секунды назад`)},
    date
  }
}
