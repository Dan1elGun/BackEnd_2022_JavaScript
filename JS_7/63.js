...
const carInfo = (car) => {
  return car.price <= 20000 ? `Цена автомобиля ${car.brand} - ${car.price}$ и это дешёвая машина` : `Цена автомобиля ${car.brand} - ${car.price}$ и это дорогая машина`
}
