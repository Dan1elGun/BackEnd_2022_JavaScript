/** ЗАДАЧА 49 - Деструктуризация объектов
 *
...
const personInfo = ({name, age : personAge, location : {country: origin, city: homeCity}, friendsQty = 0, createdAtYear = new Date}) => {
  createdAtYear.getYear();
